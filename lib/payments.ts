...
// Ask our Edge Function to verify a reference with Paystack and confirm the booking.
export async function verifyPayment(reference: string): Promise<{ ok: boolean; status: string; error?: string }> {

// Real Paystack checkout for the static frontend.
// Requires the paystack Edge Function deployed + NEXT_PUBLIC_PAYSTACK_PUBLIC_KEY set.
...
// booking.total_amount is WHOLE NAIRA (the function converts to kobo for Paystack).
